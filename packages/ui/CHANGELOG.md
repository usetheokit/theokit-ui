...
- 990cd4c: `theme-provider` and `token-usage-chart` now ship every file they import
...
- 1e275f2: the mode toggle's label and icon no longer disagree with the server
