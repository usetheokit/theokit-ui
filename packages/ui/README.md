...
[![tests](https://img.shields.io/badge/tests-1726%20passing-success?style=flat-square)](#quality-gates)
...
- **Production.** 103 components, 1726 tests passing, zero a11y violations across the axe sweep over every story, bundle size enforced. Quality gates run on every PR.
